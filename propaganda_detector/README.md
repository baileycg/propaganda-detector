...
Downloads the fine-tuned DistilBERT model (~235 MB) from GitHub Releases.
...
python main.py --model-type transformer --text "Your text here"
...
```bash
python main.py --model-type transformer --interactive
```
